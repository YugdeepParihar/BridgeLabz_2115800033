...
public class Program
{
    public static void Main()
    {
        ...
        {
            new Resume<JobRole>(softwareEngineerRole, "Sohan", "C#, .NET, SQL, Problem Solving"),
            new Resume<JobRole>(dataScientistRole, "Ram", "Python, R, Machine Learning, Data Analysis")
        };
